...
add_action('widgets_init', 'ns_basics_contact_info_widget_init');
function ns_basics_contact_info_widget_init() { 
  return register_widget('ns_basics_contact_info_widget'); 
}
